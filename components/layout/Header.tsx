    ...
    <header className="h-16 bg-fundo-light border-b border-slate-700 px-4 md:px-6 flex items-center justify-between sticky top-0 z-30">
      ...
      <div className="flex items-center gap-3">
              ...
              <div className="max-h-80 overflow-y-auto">
                {notificacoes.length === 0 ? (
                  <div className="p-6 text-center text-slate-500">
                    ...
                    <p className="text-xs mt-1">Você será notificado quando análises forem concluídas</p>
                  </div>
                ) : (
        ...
        <div className="relative" ref={userMenuRef}>
          ...
          {/* Dropdown do usuário */}
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-fundo-light border border-slate-700 rounded-xl shadow-xl overflow-hidden">
